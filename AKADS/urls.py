...
urlpatterns = [
    ...
    path(
        "logout/",
        auth_views.LogoutView.as_view(template_name="users/landing.html"),
        name="logout",
    ),
    path("home/upcoming", user_views.upcoming, name="upcoming"),
    path("home/unconfirmed", user_views.unconfirmed, name="unconfirmed"),
    path(
        "home/unconfirmed/<int:session_id>/edit",
        user_views.unconfirmed_edit,
        name="unconfirmed_edit",
    ),
    path(
        "home/unconfirmed/<int:session_id>/<str:status>",
        user_views.unconfirmed_status,
        name="unconfirmed_status",
    ),
    path("home/pending", user_views.pending, name="pending"),
    path("home/history", user_views.history, name="history"),
    path(
        "home/<int:session_id>/complete-session",
        user_views.complete_session,
        name="complete_session",
    ),
    path(
        "home/pending/<int:session_id>/cancel",
        user_views.cancel_pending,
        name="cancel_pending",
    ),
