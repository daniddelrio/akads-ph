...
; (function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
      init: function () {
          ...
          var header = $('<header>' +
              '<h5 class="month akads-dark-blue-text"></h5>' +
              '<a class="btn btn-flat btn-prev akads-dark-blue-text" href="#"><</a>' +
              '<a class="btn btn-flat btn-next akads-dark-blue-text" href="#">></a>' +
              '</header>');
      ...
      buildCalendar: function (fromDate, calendar) {
          ...
          var body = $('<table class="akads-dark-blue-text"></table>');
          ...
          var eventContainer = $('<div class="event-container"><p class="event-date">Mar 01, 2019</p><h5 class="title">Event Name</h5><a href="#" class="close"></div>');
